...
docker run --rm \
  ...
  -e TOMATO_HARVEST_INJECT_SUFFIX_REPLAN_PHASES="${TOMATO_HARVEST_INJECT_SUFFIX_REPLAN_PHASES:-}" \
  -e TOMATO_HARVEST_INJECT_LOCAL_PLAN_PHASES="${TOMATO_HARVEST_INJECT_LOCAL_PLAN_PHASES:-}" \
  -e TOMATO_HARVEST_LOCAL_PLANNER_PHASES="${TOMATO_HARVEST_LOCAL_PLANNER_PHASES:-}" \
  -e TOMATO_HARVEST_SERVO_MODE="${TOMATO_HARVEST_SERVO_MODE:-jtc}" \
