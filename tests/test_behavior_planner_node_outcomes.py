"""behavior_planner_node の成果ベースフェーズ遷移判定のテスト。
...
class DetachingOutcomeTest(unittest.TestCase):
    def setUp(self) -> None:
        from tomato_harvest_sim.robot.behavior_planner_node import detaching_outcome
...
class MovingToPlaceOutcomeTest(unittest.TestCase):
    def setUp(self) -> None:
        from tomato_harvest_sim.robot.behavior_planner_node import moving_to_place_outcome
