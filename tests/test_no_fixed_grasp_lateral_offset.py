...
def test_planners_do_not_accept_fixed_grasp_lateral_offset() -> None:
    assert "grasp_lateral_offset_m" not in inspect.signature(HarvestPoseWaypointPlanner).parameters
...
def test_runtime_does_not_expose_fixed_grasp_lateral_offset() -> None:
    paths = (
        ...
        ROOT / "src/tomato_harvest_sim/robot/motion_planner/harvest_pose_planner.py",
